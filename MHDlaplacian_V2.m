function [ laplacianRZ ] = MHDlaplacian_V2( fxn, r, z )
...
%              fxn(:,3))/dz^2; 
         %GP         
dfdrE(:,2)=((1/12)*fxn(:,2)+( -2/3)*fxn(:,2)+(2/3)*fxn(:,3)+( -1/12)*fxn(:,4))/dr;
dfdrE(:,1)=((1/12)*fxn(:,1)+( -2/3)*fxn(:,1)+(2/3)*fxn(:,2)+( -1/12)*fxn(:,3))/dr;
         
d2fdr2E(:,2)=((-1/12)*fxn(:,2)+(4/3)*fxn(:,2)+(-5/2)*fxn(:,2)+(4/3)*fxn(:,3)+(-1/12)*fxn(:,4))/dz^2; 
...
%                    fxn(:,col-2))/dz^2; 
%GP               
dfdrE(:,col-1)=-((1/12)*fxn(:,col-1)+( -2/3)*fxn(:,col-1)+(2/3)*fxn(:,col-2)+( -1/12)*fxn(:,col-3))/dr;
dfdrE(:,col)=-((1/12)*fxn(:,col)+( -2/3)*fxn(:,col)+(2/3)*fxn(:,col-1)+( -1/12)*fxn(:,col-2))/dr;  

d2fdr2E(:,col-1)=((-1/12)*fxn(:,col-1)+(4/3)*fxn(:,col-1)+(-5/2)*fxn(:,col-1)+(4/3)*fxn(:,col-2)+(-1/12)*fxn(:,col-3))/dz^2; 
...
%                        fxn(row-2,:))/dz^2; 
%GP
Zcomponent(2,:)=((-1/12)*fxn(2,:)+ (4/3)*fxn(2,:)+(-5/2)*fxn(2,:)+ (4/3)*fxn(3,:)+ (-1/12)*fxn(4,:))/dz^2;
Zcomponent(1,:)=((-1/12)*fxn(1,:)+ (4/3)*fxn(1,:)+(-5/2)*fxn(1,:)+ (4/3)*fxn(2,:)+ (-1/12)*fxn(3,:))/dz^2;
Zcomponent(row+1,:)=((-1/12)*fxn(row+1,:)+ (4/3)*fxn(row+1,:)+(-5/2)*fxn(row+1,:)+ (4/3)*fxn(row+2,:)+ (-1/12)*fxn(row+3,:))/dz^2;
...
%GP
dfdr(2,2)=((1/12)*fxn(2,2)+(-2/3)*fxn(2,2)+(2/3)*fxn(2,3)+(-1/12)*fxn(2,4))/dr;
dfdr(2,1)=((1/12)*fxn(2,1)+(-2/3)*fxn(2,1)+(2/3)*fxn(2,2)+(-1/12)*fxn(2,3))/dr;
dfdr(1,2)=((1/12)*fxn(1,2)+(-2/3)*fxn(1,2)+(2/3)*fxn(1,3)+(-1/12)*fxn(1,4))/dr;
...
%                            +fxn(2,3) )/dz^2;
%GP
d2fdr2(2,2)=-((-1/12)*fxn(2,2)-(4/3)*fxn(2,2)+(-5/2)*fxn(2,2)+(4/3)*fxn(2,3)-(-1/12)*fxn(2,4))/(dr^2);  
d2fdr2(2,1)=-((-1/12)*fxn(2,1)-(4/3)*fxn(2,1)+(-5/2)*fxn(2,1)+(4/3)*fxn(2,2)-(-1/12)*fxn(2,3))/(dr^2);  
d2fdr2(1,2)=-((-1/12)*fxn(1,2)-(4/3)*fxn(1,2)+(-5/2)*fxn(1,2)+(4/3)*fxn(1,3)-(-1/12)*fxn(1,4))/(dr^2);  
...
%GP
dfdr(2,col-1)=((1/12)*fxn(2,col-1)+(-2/3)*fxn(2,col-1)+(2/3)*fxn(2,col-2)+(-1/12)*fxn(2,col-3))/dr;
dfdr(2,col)=((1/12)*fxn(2,col)+(-2/3)*fxn(2,col)+(2/3)*fxn(2,col-1)+(-1/12)*fxn(2,col-2))/dr;
dfdr(1,col-1)=((1/12)*fxn(1,col-1)+(-2/3)*fxn(1,col-1)+(2/3)*fxn(1,col-2)+(-1/12)*fxn(1,col-3))/dr;
...
%                            +fxn(2,col-2) )/dz^2;
%GP     
d2fdr2(2,col-1)=((-1/12)*fxn(2,col-1)+(4/3)*fxn(2,col-1)+(-5/2)*fxn(2,col-1)+(4/3)*fxn(2,col-2)+(-1/12)*fxn(2,col-3))/(dr^2);
d2fdr2(2,col)=((-1/12)*fxn(2,col)+(4/3)*fxn(2,col)+(-5/2)*fxn(2,col)+(4/3)*fxn(2,col-1)+(-1/12)*fxn(2,col-2))/(dr^2);                   
d2fdr2(1,col-1)=((-1/12)*fxn(1,col-1)+(4/3)*fxn(1,col-1)+(-5/2)*fxn(1,col-1)+(4/3)*fxn(1,col-2)+(-1/12)*fxn(1,col-3))/(dr^2);           
...
%GP
Zcomponent(row-1,2) = ((-1/12)*fxn(row-1,2) +(4/3)*fxn(row-1,2) +(-5/2)*fxn(row-1,2)+(4/3)*fxn(row-2,2)+(-1/12)*fxn(row-3,2) )/dz^2;
Zcomponent(row-1,1) = ((-1/12)*fxn(row-1,1) +(4/3)*fxn(row-1,1) +(-5/2)*fxn(row-1,1)+(4/3)*fxn(row-2,1)+(-1/12)*fxn(row-3,1) )/dz^2;
...
%                            +fxn(row-2,col-1) )/dz^2;
 %GP                       
Zcomponent(row-1,col-1) = ((-1/12)*fxn(row-1,col-1) +(4/3)*fxn(row-1,col-1) +(-5/2)*fxn(row-1,col-1)+(4/3)*fxn(row-2,col-1)+(-1/12)*fxn(row-3,col-1) )/dz^2;
Zcomponent(row-1,col) = ((-1/12)*fxn(row-1,col) +(4/3)*fxn(row-1,col) +(-5/2)*fxn(row-1,col)+(4/3)*fxn(row-2,col)+(-1/12)*fxn(row-3,col) )/dz^2;                       
